...
export const EditDrinkForm = ({ id, references, onClose, onEdited }: EditDrinkFormProps) => {
    ...
    const fetchDrink = async () => {
      try {
        ...
        const data = {
          ...
          sweetness_id: drink.sweetness?.id || null,
          alc: drink.alc || undefined,
          sugar: drink.sugar || undefined,
          age: drink.age || '',
