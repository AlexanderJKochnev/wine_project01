# app/core/repositories/alchemy_future_repository.py
# когда нибудь разобраться - лучше это или просто сложнее
...
class SqlAlchemyRepositor(AbstractRepository, Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
