...
from app.support.parser.model import Name, Rawdata
from app.support.parser.utils.html_parser import parse_rawdata_html, parse_html_to_dict
...
class WorkerSettings:
    functions = [parse_rawdata_task, parse_all_rawdata_task]
